...
const CreateFlightRouteSuccessMessage = "Direct flight route created: %s -> %s  (%s, Day %d)"
...
const AvailableSeatsMessage = "%d seat(s) available on %s -> %s\n"
const BookingSuccessMessage = "Booking Confirmed! Booking ID: %d\n"
const BookingDetailMessage = "Seat #%d on %s -> %s\n"
